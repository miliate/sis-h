<?php
/**
 * This model works with information in database, which relates to patients.
...
class Mpatient extends My_Model
{
    ...
    function get_previous_injection_list($pid)
    {
		...
		$sql .= " WHERE (patient_injection.Active=1) and (patient_injection.PID = '$pid')";
	...
	function get_notes_list($pid,$tbl=null)
    {
		...
		/*if ($tbl == "patient"){*/
			...
			$sql .= " WHERE (patient_notes.Active=1) and (patient_notes.PID = '$pid')";
