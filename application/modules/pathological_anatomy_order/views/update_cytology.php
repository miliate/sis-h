...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            $form_generator->checkboxes_pa(lang('CYTOLOGY OF LIQUIDS'), 'cytology_liquids', $group1_options, $checked1, $default_value, 1);
            $form_generator->checkboxes_pa(lang('PAAF'), 'paaf', $group2_options, $checked2, $default_value, 2);
...
<script type="text/javascript">
    $(document).ready(function(){
        $('input[type="checkbox"][value="Washes"]').click(function(){
        ...
        $('input[type="checkbox"][value="Others_Liquid"]').click(function(){
            if($(this).prop("checked") == true){
        ...
        $('input[type="checkbox"][value="Ganglion"]').click(function(){
            if($(this).prop("checked") == true){
        ...
        $('input[type="checkbox"][value="Soft_Tissues"]').click(function(){
            if($(this).prop("checked") == true){
        ...
        $('input[type="checkbox"][value="Others_PAAF"]').click(function(){
            if($(this).prop("checked") == true){
