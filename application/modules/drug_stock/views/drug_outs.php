<div class="row">
    ...
    <div class="col-md-10 ">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                ?>
                <h4><?= lang('Medication Exit Report') ?></h4>
                <hr>
                        ...
                        <table class="table table-responsive table-stripped" id="tb-report">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 10px;"><?= lang('Dosage') ?></th>
                                    <th><?= lang('Internal Prescriptions') ?></th>
                                    <th><?= lang('External Prescriptions') ?></th>
                                    <th><?= lang('Negative Adjustments') ?></th>
                                    <th><?= lang('Wastes') ?></th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <script>
        $('#btn-generate').click(function() {
            ...
            $.get(`getOutsOn/${startDate}/${endDate}`, function(data) {
                ...
                $.each(data, function(k, record) {
                    ...
                    $("#tb-report").find('tbody')
                        .append($('<tr>')
                            ...
                            .append($('<td>').append(record.internals))
                            .append($('<td>').append(record.externals))
                            .append($('<td>').append(record.negatives))
                            .append($('<td>').append(record.wastes))
                        );
                });
            }).fail(function(error) {});
        });
