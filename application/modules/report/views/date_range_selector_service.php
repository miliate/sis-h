...
$model .= "                <thead>\n";
$model .= "                <tr>\n";
$model .= "                    <th>From: <input type=\"text\" class=\"span2\" value=\"$now\" id=\"" . $id . "_dpd1\"></th>\n";
$model .= "                    <th>To: <input type=\"text\" class=\"span2\" value=\"$now\" id=\"" . $id . "_dpd2\"></th>\n";
$model .= "                    <th>Service: ". form_dropdown('service', $services, '', ' id="service"') ."</th>\n";
$model .= "                </tr>\n";
$model .= "                </thead>\n";
$model .= "            </table>\n";
...
$js .= "        var lookUpW = window.open(\"" . $url
    . "/\" + $(\"#{$id}_dpd1\").val() + \"/\" + $(\"#{$id}_dpd2\").val() + \"/\" + $(\"#service\").val(), \"lookUpW\", params);\n";
$js .= "    }\n";
$js .= "</script>";
echo $model . $js;
