...
$sql = "select a.PID as pid,p.Firstname as patient,p.Name as patient2,a.Complaint as complaint,u.Name as doctor,u.OtherName as doctor2,a.OutCome as outcome,w.`Name` as ward from admission as a,patient as p,`user` as u,ward as w where a.AdmissionDate LIKE '$date%' and a.PID=p.PID and a.Doctor=u.UID and a.Ward=w.WID order by p.PID";
