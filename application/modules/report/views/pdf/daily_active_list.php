...
$pdf->writeSubTitle('Registro de '. $department. ' ' . $date);
...
$query = "SELECT 
    ...
    WHERE patient_active_list.Department = '". $department. "' AND patient_active_list.CreateDate like '". $date. "%'";
unset($result);
...
$pdf->Output('Registro de '. $department . ' ' .$date. '.pdf', 'I');
?>
