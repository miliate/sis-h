...
$user_printer = $this->session->userdata('title') . ' ' . $this->session->userdata('name') . ' ' . $this->session->userdata('other_name');
    ...
    $pid = $patient->PID;
    $doc_num='SISH-<b>'.$hid.substr($patient->CreateDate,0,4).$pid.'</b>';
...
$text = '<table width="100%" border="1" align="center">
  <tr align="center">
    <td width="40%" rowspan="3" valign="top"><p>&nbsp;</p>
      <p align ="center">
      <img  src="images/moz.png" width="35px"  hight="35px"/>
      <br>
      REP&Uacute;BLICA DE MO&Ccedil;AMBIQUE<br>
      SERV&Iacute;&Ccedil;O NACIONAL DE SA&Uacute;DE <br>
      <img  src="images/hcq.png" width="75px"  hight="75px"/><br>
    <font color="#00008b"  size="15px"><b>'.$hospital_name.'</b></font>
    </p>


		<p>Unidade Sanit&aacute;ria N.<sup>o</sup>: &nbsp;<b><font>'.$hid.'</font></b></p>
	...
	<tr>
    <td align="center"><font size="15px">PROCESSO DE CONSULTA     <b>NID:<font color="#ff0000">'.$pid.'</font></b></font></td>
  </tr>
  <tr>
    <td rowspan="2">
...
<br> <font size="-1"> Processado por computador, em '.date("d-m-Y H:m:s").' Operador:  '.$user_printer.' '.$doc_num.'</font>';
