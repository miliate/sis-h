    ...
    <div class="col-md-10">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="text-center"><?php echo lang('Admission Report by Gender and Age Group')?></h4>
                <hr>
                ...
                <div id="table-container" class="row" style="margin-top: 20px;">
                    <div class="col-md-12">
                        <table class="table table-responsive table-stripped" id="reportTable">
                            <thead>
                                <tr>
                                    <th rowspan="2"><?php echo lang('Reason for Admission')?></th>
                                ...
                                <tr>
                                    ...
                                    <th>M</th>
                                    <th>F</th>
                                    <th colspan="2" class="text-center"><?php echo lang('Grand Total')?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if (!empty($data)) : ?>
                                    <?php foreach ($data as $item) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $item['M_0_14']; ?></td>
                                            <td><?php echo $item['M_15_24']; ?></td>
                                            <td><?php echo $item['M_25_49']; ?></td>
                                            <td><?php echo $item['M_50_59']; ?></td>
                                            <td><?php echo $item['M_60_plus']; ?></td>
                                            <td><?php echo $item['F_0_14']; ?></td>
                                            <td><?php echo $item['F_15_24']; ?></td>
                                            <td><?php echo $item['F_25_49']; ?></td>
                                            <td><?php echo $item['F_50_59']; ?></td>
                                            <td><?php echo $item['F_60_plus']; ?></td>
                                            <td><?php echo $item['Total_M']; ?></td>
                                            <td><?php echo $item['Total_F']; ?></td>
                                            <td style="text-align: center;"><?php echo $item['Total_Geral']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else : ?>
                                    <tr><td colspan="13" class="text-center"><?php echo lang ('No data found')?> </td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#filterForm').on('submit', function(event) {
            ...
            $.ajax({
                url: `<?php echo site_url('report/getAdmissionReportData'); ?>/${startDate}/${endDate}/${period}`,
                method: "GET",
                dataType: "json",
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        $('#reportTable tbody').append('<tr><td colspan="13" class="text-center"><?php echo lang ('No data found')?></td></tr>');
                    }
                },
                error: function() {
