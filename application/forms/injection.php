...
//pager starts
$form["CAPTION"]  = lang('Injection')." <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'".site_url('injection/create')."\' value=\'Adicionar\'>";
$form["ACTION"]  = base_url()."index.php/injection/edit/";
...
$form["DISPLAY_LIST"] = array( lang('injection_id'), lang('Name'), lang('Dosage'),lang('Route'), lang('Remarks'), lang('Active'));
//pager ends
$form["FLD"]=array(
array(		
		"id"=>"name", 
