...
//pager starts
$form["CAPTION"]  = lang('Treatment')." <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'".site_url('treatment/create')."\' value=\'Adicionar\'>";
...
$form["DISPLAY_LIST"] = array( lang('TREATMENTID'), lang('Treatment'), lang('Type'), lang('Remarks'), lang('Active'));
//pager ends
$form["FLD"]=array(
array(		
		"id"=>"Treatment", 
