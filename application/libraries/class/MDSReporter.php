...
//	}
    ...
    public function setBarcode($barcode, $x = 0, $y = 0, $frame = false, $pb = 30, $text = true, $w = 0.4, $h = 10)
    {
        ...
        if ($frame) {
            $this->Code39($x, $y, $barcode, true, false, $w, $h, false, $text);
